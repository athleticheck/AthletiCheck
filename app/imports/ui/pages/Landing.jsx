    ...
    return (
        <div>
          <div className='background-landing'>
            <Grid id='landing-page' container columns={2} verticalAlign="middle" textAlign="center" style={menuStyle}>
              <Grid.Row>
                <Grid.Column>
                ...
                <Grid.Column>
                  ...
                  <div>
                    <Button id="landing-aboutUs" size='small' inverted as={NavLink} activeClassName="active" exact to="/about"> Read more about us.</Button>
                  </div>
                </Grid.Column>
              </Grid.Row>
            </Grid>
